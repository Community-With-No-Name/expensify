...
export default function transaction() {
  ...
  const categoriseTransactions = (allTransactions) => {
  ...
  React.useEffect(() => {
    if (data && data.data){
      ...
      const categorisedTransactions = categoriseTransactions(allTransactions);
      setTransactions(categorisedTransactions);
    }
